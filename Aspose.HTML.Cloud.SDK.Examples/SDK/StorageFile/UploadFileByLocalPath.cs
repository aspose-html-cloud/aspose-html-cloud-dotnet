...
namespace Aspose.HTML.Cloud.Examples.SDK.StorageFile
{
    ...
    /// =========================================
    /// Example that demonstrates how to upload a file to the storage by its local file system path
    /// and check if file has been uploaded successfully.
    /// </summary>
    class UploadFileByLocalPath : ISdkRunner
    {
        public void Run()
        {
            ...
            var response = fApi.UploadFile(srcPath, dstPath, storage);
