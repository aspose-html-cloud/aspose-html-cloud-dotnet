...
namespace Aspose.HTML.Cloud.Examples.SDK.StorageFile
{
    ...
    /// =========================================
    /// Example that demonstrates how to copy a file to other file in the storage 
    /// and check if copy operation succeeded.
    /// </summary>
    public class CopyFile : ISdkRunner
    {
        public void Run()
        {
            ...
            IStorageFileApi fileApi = new StorageApi(CommonSettings.AppSID, CommonSettings.AppKey, CommonSettings.BasePath);
            var response = fileApi.CopyFile(srcPath, destPath, storage, storage, versionId);
