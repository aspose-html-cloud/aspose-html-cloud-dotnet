...
namespace Aspose.HTML.Cloud.Live.Demos.UI.Config
{
	/// <summary>
	/// Wrapper class for Aspose.HTML Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposeHTMLCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeHTMLCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeHTMLCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeHTMLCloudContext atcc { set { atc = value; } }
		internal static AsposeHTMLCloudContext Current
		{
			get { return atc; }
		}
