...
namespace Aspose.HTML.Cloud.Live.Demos.UI.Config
{
    ...
    {
        private AsposeHTMLCloudContext _atContext;
        ...
        public AsposeHTMLCloudContext AsposeHTMLCloudContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeHTMLCloudContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeHTMLCloudContext.atcc = AsposeHTMLCloudContext;
            base.OnLoad(e);
        }
    }
}
