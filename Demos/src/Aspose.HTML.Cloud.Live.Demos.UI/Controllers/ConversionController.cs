using Aspose.HTML.Cloud.Live.Demos.UI.Models.Common;
		...
		public Response Conversion(string outputType)
		{
			...
			foreach (string fileName in Request.Files)
			{
				...
				if (postedFile != null)
				{
					...
					{
						AsposeHTMLConversion asposeHTMLConversion = new AsposeHTMLConversion();
							 response = asposeHTMLConversion.Convert(isFileUploaded.FileName, isFileUploaded.FolderId,   outputType.ToLower().Replace(" ", ""));
