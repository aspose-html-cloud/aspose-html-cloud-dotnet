...
namespace Com.Aspose.Html.Api
{
    ...
    public class ConversionApi : IConversionApi
    {
            ...
            string storage = null)
        {
            ...
            path = path.Replace("{" + "format" + "}", ApiClient.ParameterToString(format));
            ...
            if (outPath != null) queryParams.Add("outPath", ApiClient.ParameterToString(outPath)); // query parameter
             ...
             if (leftMargin != null) queryParams.Add("leftMargin", ApiClient.ParameterToString(leftMargin)); // query parameter
             if (rightMargin != null) queryParams.Add("rightMargin", ApiClient.ParameterToString(rightMargin)); // query parameter
             if (topMargin != null) queryParams.Add("topMargin", ApiClient.ParameterToString(topMargin)); // query parameter
             if (bottomMargin != null) queryParams.Add("bottomMargin", ApiClient.ParameterToString(bottomMargin)); // query parameter
             if (xResolution != null) queryParams.Add("xResolution", ApiClient.ParameterToString(xResolution)); // query parameter
             if (yResolution != null) queryParams.Add("yResolution", ApiClient.ParameterToString(yResolution)); // query parameter
            ...
            string folder = null, string storage = null)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToImage: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToImage: " + response.ErrorMessage, response.ErrorMessage);
            ...
            string storage = null)
        {
            ...
            queryParams.Add("sourceUrl", ApiClient.ParameterToString(sourceUrl)); // query parameter
            ...
            string folder = null, string storage = null)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToPdf: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToPdf: " + response.ErrorMessage, response.ErrorMessage);
            ...
            int? topMargin = default(int?), int? bottomMargin = default(int?), string storage = null)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToPdfByUrl: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToPdfByUrl: " + response.ErrorMessage, response.ErrorMessage);
            ...
            int? topMargin = default(int?), int? bottomMargin = default(int?), string folder = null, string storage = null)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToXps: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToXps: " + response.ErrorMessage, response.ErrorMessage);
            ...
            int? topMargin = default(int?), int? bottomMargin = default(int?), string storage = null)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToXpsByUrl: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling GetConvertDocumentToXpsByUrl: " + response.ErrorMessage, response.ErrorMessage);
